...
const Header = () => {
  ...
  return (
    <Disclosure as="nav" className="bg-grey dark:bg-cyan-600 ">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-red-600 hover:text-red-900 dark:text-red-800 dark:hover:text-red-800">
                  ...
                  <div className="flex space-x-4">
                    ...
                    {isAuth ? (
                      <>
                        <Link
                          to={'/'}
                          className='bg-slate-400 p-2 px-4 rounded-lg text-black dark:bg-purple-600 dark:text-white' 
                        >
                          Home
                        </Link>
                        ...
                        <Link
                          to={'/cate'}
                          className='text-black p-2 px-4 rounded-lg hover:bg-slate-400 dark:text-gray-300 dark:hover:bg-teal-700 dark:hover:text-white'
                        >
                          Categories
                        </Link>
                      </>
                        ...
                        <>
                          <Link
                            to={'/login'}
                            className='bg-slate-400 p-2 px-4 rounded-lg text-black dark:bg-teal-700 dark:text-white' 
                          >
                            Log in
                          </Link>
              ...
              <div className="relative hidden md:block">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <svg className="w-5 h-5 text-purple-500" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path></svg>
                ...
                className="block w-full md:w-[200px] lg:w-[400px] xl:w-[600px] p-2
                  pl-10 text-sm text-gray-900 border border--300 rounded-full 
                  bg-gray-50 dark:bg-gray-300 outline-none
                  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white 
                  " placeholder="busca uwu"/>
              </div>
              ...
              <div className="absolute space-x-2 inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                >
                  {darkMode ? 
                    ...
                    <BsFillMoonStarsFill size={20} className="text-purple-900 hover:text-white "/> 
                ...
                <Link to={'/cart'} className="text-slate-900 hover:text-black dark:text-purple-900 dark:hover:text-white">
                  <HiOutlineShoppingBag size={23}/>
                </Link>
                <span className="text-slate-900 dark:text-purple-900">{cart.length}</span>
